...
List data;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBar(
        backgroundColor: Color.fromRGBO(132,94,194, 5),
        title: Center(child: Text("GoCorona | India",style: GoogleFonts.varelaRound(),)),
      ),
      body: Container(
       child: ListView(
         ...
         children: <Widget>[
           ...
           Padding(
             ...
             child: Text("Hey Guys!!, As We all know Covid-19 is almost everywhere. So Plz... Stay Home 🏡 and Stay Safe😷",style: GoogleFonts.varelaRound(color:Colors.black87,fontSize: screenWidth*0.06,fontWeight: FontWeight.w300),),
           ),
           Padding(
             padding: const EdgeInsets.all(20.0),
           ...
           Row(
             ...
             children: <Widget>[
               Container(
                 ...
                 child: Text("#GoCoronaGo",style: GoogleFonts.varelaRound(color:Colors.white),),
               ),
               ),
               Container(
                 decoration: BoxDecoration(
             ...
             children: <Widget>[
               ...
               Padding(
                 ...
                 child: Container(
                   ...
                   decoration: BoxDecoration(
                     color:Color.fromRGBO(132,94,194, 5),
