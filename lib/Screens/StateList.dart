                ...
                child: GridTile(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text(data[i]['state'],textAlign: TextAlign.center,style: GoogleFonts.varelaRound(fontSize: 16,color:Colors.purple.shade600,fontWeight: FontWeight.w700),) :
                                      Text(data[i]['state'],textAlign: TextAlign.center,style: GoogleFonts.varelaRound(fontSize: 20,color:Colors.purple.shade600,fontWeight: FontWeight.w700),),
